...
let asideAnimated = false;
let serviceAnimated = false;
let priceAnimated = false;
let imageAnimated = false;
let chooseAnimated = false;
let aboutImgAnimated = false;
let aboutContentAnimated = false;
let freqAnimated = false;
...
const doAnimation = (scroll) => {
  ...
  if (isInViewport(asideEl) && !asideAnimated) {
    asideEl.classList.add(
      "animate__animated",
      "animate__fadeInLeft",
      "animate__delay-2s"
    );
  ...
  if (isInViewport(serviceEl) && !serviceAnimated) {
    serviceEl.classList.add(
      "animate__animated",
      "animate__zoomIn",
      "animate__delay-2s"
    );
  ...
  //  price section
  const priceEl = document.getElementById("servicesPrice");
  if (isInViewport(priceEl) && !priceAnimated) {
    for (let e of priceEl.children) {
      e.classList.add(
        "animate__animated",
  ...
  if (isInViewport(serviceEl) && !imageAnimated) {
  ...
  if (isInViewport(chooseEl) && !chooseAnimated) {
    chooseEl.classList.add(
      "animate__animated",
      "animate__fadeInRight",
      "animate__delay-2s"
    );
    chooseEl.classList.remove("hide");
    chooseAnimated = true;
  }

  // about-image section
  const aboutImageEl = document.getElementById("about-img");
  if (isInViewport(aboutImageEl) && !aboutImgAnimated) {
    aboutImageEl.classList.add(
      "animate__animated",
      "animate__fadeInLeft",
      "animate__delay-3s"
    );
    aboutImageEl.classList.remove("hide");
    aboutImgAnimated = true;
  }
  // about-image section
  const aboutContentEl = document.getElementById("about-content");
  if (isInViewport(aboutContentEl) && !aboutContentAnimated) {
    aboutContentEl.classList.add(
      "animate__animated",
      "animate__fadeInRight",
      "animate__delay-2s"
    );
    aboutContentEl.classList.remove("hide");
    aboutContentAnimated = true;
  }

  // frequence asked question section
  const qstEl = document.getElementById("qstn");
  if (isInViewport(qstEl) && !freqAnimated) {
    qstEl.classList.add(
      "animate__animated",
      "animate__fadeInLeft",
      "animate__delay-2s"
    );
    qstEl.classList.remove("hide");
    freqAnimated = true;
  }
